...
-defualt missing projecct name to `Untitled Project`
-use the schema's existion ID strategy, do not add sequential IDs 

Security:

-Unauthentication requests return `401`
-only the project owner can rename or delete 
-non-owner mutations return `403`

Keep thi backend-only. Do not wire the UI yet.
